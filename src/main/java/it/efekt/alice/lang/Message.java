...
public enum Message {
    ...
    CMD_PLAY_FULL_USAGE_INFO("`ytsearch:` `keywords` - searches YouTube\n`scsearch:` `keywords` - searches SoundCloud\nexample: `play ytsearch: darude sandstorm`"),
    CMD_PLAY_SHORT_USAGE_INFO("`url` or `ytsearch: keywords` or `scsearch: keywords`"),
